...
const Admin = () => {
  ...
  const itensMenuAdmin = [
    { id: 'coordenadores', name: 'Gestao de Coordenadores', icon: <Users size={20} color="white" />, onClick: () => navigate('/admin') },
    ...
    { id: 'logs', name: 'Logs', icon: <BarChart3 size={20} color="white" />, onClick: () => navigate('/logs') },
  ];

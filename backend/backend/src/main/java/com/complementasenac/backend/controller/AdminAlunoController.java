...
public class AdminAlunoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AlunoAdminModel> buscarPorId(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<AlunoAdminModel> atualizar(@PathVariable Long id, @RequestBody AlunoAdminModel aluno) {
